            ...
            <tr>
                ...
                <td>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 6px;">
                        <tr>
                            <td width="35" class="valign-bottom" style="font-size: 12px;">Socio</td>
                            <td class="valign-bottom" style="border-bottom: 1px dashed #666;"></td>
                        </tr>
                    </table>

                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 6px;">
                        <tr>
                            <td width="18" class="valign-bottom" style="font-size: 12px;">Nº</td>
                            <td width="40" class="valign-bottom" style="border-bottom: 1px dashed #666;"></td>
                            <td width="15" class="valign-bottom" style="text-align: center; font-weight: bold;">$</td>
                            <td class="valign-bottom" style="border-bottom: 1px dashed #666;"></td>
                        </tr>
                    </table>

                    <div class="ticket-mes">{{ $mes }}</div>

                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-top: 35px;">
                        <tr>
                            <td width="40" class="valign-bottom" style="font-weight: bold; font-size: 12px;">20_ _ _
                            </td>
