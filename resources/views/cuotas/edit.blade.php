<x-app-layout>
    <div class="container-fluid px-4 px-md-5 mt-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold">Editar Pago de Cuota</h2>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="socio_id" id="socio_id" class="form-select" required>
                                ...
                                <option value="{{ $socio->id }}" {{ old('socio_id', $cuota->socio_id) == $socio->id ?
                                    'selected' : '' }}>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="mes" id="mes" class="form-select" required>
                                @for ($i = 1; $i <= 12; $i++) <option value="{{ $i }}" {{ old('mes', $cuota->mes) == $i
                                    ? 'selected' : '' }}>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" name="anio" id="anio" class="form-control"
                                value="{{ old('anio', $cuota->anio) }}" required>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" min="0" name="monto" id="monto" class="form-control"
                                    value="{{ old('monto', $cuota->monto) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="fecha_pago" class="form-label">Fecha de Pago</label>
                            <input type="date" name="fecha_pago" id="fecha_pago" class="form-control"
                                value="{{ old('fecha_pago', \Carbon\Carbon::parse($cuota->fecha_pago)->format('Y-m-d')) }}"
                                required>
                        </div>
                    </div>

                    <div class="mt-4">
                        <button type="submit" class="btn btn-success"><i class="bi bi-check-circle"></i> Guardar
                            Cambios</button>
