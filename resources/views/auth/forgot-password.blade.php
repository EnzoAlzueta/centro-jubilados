    ...
    <div class="container d-flex justify-content-center align-items-center vh-100 px-3">
        <div class="card-shadow border-0 p-4"
            ...
            <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
                {{ __('¿Olvidaste tu contraseña? No hay problema. Simplemente dinos tu dirección de correo electrónico y
                te mostraremos tu pregunta de seguridad para restablecerla.') }}
            </div>

            <form method="GET" action="{{ route('password.security-question.show') }}">
                <div class="mb-3">
                    <label for="email" class="form-label small fw-bold text-secondary">Ingrese correo
                        electrónico</label>
